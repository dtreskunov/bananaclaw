...
function PrivateWebView({ groupId, path, title, fragment }) {
  ...
  if (error) {
    return /* @__PURE__ */ u3("div", { class: "private-web-view private-web-state", role: "alert", children: [
      /* @__PURE__ */ u3("p", { children: error }),
      /* @__PURE__ */ u3("button", { type: "button", onClick: () => {
        refreshingRef.current = true;
        setRevision((value) => value + 1);
      }, children: "Try again" })
    ] });
  }
  if (!url) return /* @__PURE__ */ u3("div", { class: "private-web-view private-web-state", "aria-busy": "true", children: "Loading page" });
  return /* @__PURE__ */ u3("div", { class: "private-web-view", children: /* @__PURE__ */ u3(
    "iframe",
    {
      ref: frameRef,
      src: url,
...
// src/private-web-entry.tsx
var root = document.getElementById("private-web-root");
if (root) {
